...
try:
    ...
    from agents.arxiv_finder.content import *
    from agents.arxiv_finder.functions import *
    ...
    from agents.arxiv_finder.agent import create_arxiv_finder_agent
    agent = create_arxiv_finder_agent(mock_triage)

    def test_memory_manager():
        memory_manager.clear_agent('arxiv_finder')
        test_data = {'test': 'data'}
        memory_manager.store('arxiv_finder', 'test_key', test_data)
        retrieved = memory_manager.retrieve('arxiv_finder', 'test_key')
    ...
    print("Running tests for arxiv_finder agent...")
    test_memory_manager()
